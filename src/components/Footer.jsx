        ...
        <div className='socIcons'>
            ...
            <div className='footerDiv'>
                <div className='collaborateDiv'>
                    <Typography sx={{color: "snow"}}><span style={{
                        color: "rgba(136, 132, 255)",
                        fontWeight: '500',
                        }}>Collaborate</span> <span style={{
                            position: 'relative',
                            
                        }}>or Get in Touch with me</span></Typography>
                    <Button onClick={sendEmail}><EmailIcon sx={{
                        fontSize: '3.5em'
                    }}/></Button>
                </div>
